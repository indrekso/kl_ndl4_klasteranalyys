...
Arvutasime siin keskmise soo tunnusest, mis võib tekitada k?simusi - kuidas võiks olla õigustatud nominaaltunnusest keskmise arvutamine? Antud juhul on tegu kaheväärtuselise tunnusega, seega juhul, kui ühe kategooria kood on null ja# teise oma üks, siis saame keskmise arvutamisel teise kategooria osakaalu (sisuliselt naiste protsendi kõigist  indiviididest).
...
Kui R ütleb eelviimase käsu peale `Skipping install of 'SWKM' from a github remote, the SHA1 (b8763db3) has not changed since last install. Use ``force = TRUE`` to force installation`, siis võib proovida veel
...
Teeme eelnevalt tehtud klasterduse näite rahulolu tunnuste ja kolme klastriga läbi nüüd ka kaalutud andmetega, enne  tuleb andmestik muuta maatriksiks nagu `kmeans.weight` nõuab. 
